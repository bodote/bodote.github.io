...
git checkout v1.0
```
oder verwende `ng new tdd-angular` und reduziere dann `src/app/app.component.ts` auf ein Minimum , z.B. Lösche alles und setzte  `<div>{{ title }} app is running!</div>` ein.
